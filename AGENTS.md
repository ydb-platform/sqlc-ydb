...
- Changes must not add complexity to production/runtime code; tests and test harnesses are exempt. If runtime complexity is unavoidable, categorically justify why the task or problem cannot be solved without adding complexity and why simpler alternatives are insufficient.

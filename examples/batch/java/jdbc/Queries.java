...
public final class Queries {
    ...
    public void createAuthors(java.util.List<CreateAuthorsAuthorsItem> authors) throws java.sql.SQLException {
        try (var _prepared = client.unwrap(tech.ydb.jdbc.YdbConnection.class).prepareStatement("""
    ...
    public void upsertAuthors(java.util.List<UpsertAuthorsAuthorsItem> authors) throws java.sql.SQLException {
        try (var _prepared = client.unwrap(tech.ydb.jdbc.YdbConnection.class).prepareStatement("""
            DECLARE $authors AS List<Struct<name: Utf8, author_id: Uint64,>>;

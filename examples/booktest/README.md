...
This example adapts sqlc's `booktest` examples at commit `3c2546a4b47fabbcec3e07df420effb1a464728f` to YDB and generates both native YDB SDK and `database/sql` Go packages.

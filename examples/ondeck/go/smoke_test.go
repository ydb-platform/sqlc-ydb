...
func TestLive(t *testing.T) {
	db := testdb.Open(t)
	db.Apply(t, "../schema/0001_city.sql", "DROP TABLE city;")

	venueTable := "venues"
	db.Apply(t, "../schema/0002_venue.sql")
	t.Cleanup(func() {
	...
	db.Apply(t, "../schema/0003_rename_venue.sql")
	venueTable = "venue"
	db.Apply(t, "../schema/0004_add_created_at.sql")
	db.Apply(t, "../schema/0005_drop_column.sql")

...
final class Queries
{
    ...
    public function listVenues(string $city): array
    {
        ...
        $rows = $this->decodeRows(
            ...
            [
                ...
                ['spotify_playlist', PrimitiveTypeId::UTF8, true],
            ...
            static fn($items): ListVenuesRow => new ListVenuesRow(
                ...
                YdbValueCodec::optionalUtf8($items->offsetGet(6), 'ListVenues.spotify_playlist'),
    ...
    public function getVenue(GetVenueParams $params): ?GetVenueRow
    {
        ...
        $rows = $this->decodeRows(
            ...
            static fn($items): GetVenueRow => new GetVenueRow(
                ...
                YdbValueCodec::optionalUtf8($items->offsetGet(6), 'GetVenue.spotify_playlist'),
    ...
    public function createVenue(CreateVenueParams $params): ?CreateVenueRow
    {
        $parameters = [
            ...
            '$spotify_playlist' => YdbValueCodec::typedOptionalUtf8($params->spotifyPlaylist, 'spotify_playlist'),

...
public:
    ...
    void UpsertPrimaryUser(std::uint64_t id, const std::string& name) const;
    void UpsertSecondaryUser(std::uint64_t id, const std::string& name) const;
    ...
    std::vector<FindPrimaryUsersByNameRow> FindPrimaryUsersByName(const std::string& name) const;

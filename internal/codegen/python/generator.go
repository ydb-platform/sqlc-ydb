...
func Generate(a *model.AnalysisResult, o Options) ([]model.File, error) {
	...
	if err := validateNames(a, o); err != nil {
		return nil, err
	}
	m, err := renderModels(a, o)
	if err != nil {
		return nil, err
	}
...
func validateNames(a *model.AnalysisResult, o Options) error {
	methods, classes := map[string]string{}, map[string]string{}
	if nativeJSONResults(a, o) {
		classes["JSONValue"] = "native JSON result type"
	}
...
func renderModels(a *model.AnalysisResult, o Options) (string, error) {
	var b strings.Builder
	b.WriteString("# Code generated by sqlc-ydb. DO NOT EDIT.\nfrom dataclasses import dataclass\nfrom datetime import date, datetime, timedelta\nfrom uuid import UUID\nfrom typing import Optional\n\n")
	if nativeJSONResults(a, o) {
		b.WriteString("from typing import Union\n\nJSONValue = Union[None, bool, int, float, str, list[\"JSONValue\"], dict[str, \"JSONValue\"]]\n\n")
	}

...
func Generate(in *model.AnalysisResult, options Options) ([]model.File, error) {
	...
	header, err := renderHeader(in, options)
	if err != nil {
		return nil, err
	}
	source, err := renderSource(in, options)
	if err != nil {
		return nil, err
	}
	return []model.File{
		{Name: "models.hpp", Content: []byte(models)},
		{Name: "queries.hpp", Content: []byte(header)},
		{Name: "queries.cpp", Content: []byte(source)},
	}, nil
}
...
func validateNamespace(namespace string) error {
	...
	if len(parts) == 0 {
		return fmt.Errorf("invalid C++ namespace %q", namespace)
	}
...
func renderHeader(in *model.AnalysisResult, options Options) (string, error) {
	var out strings.Builder
	out.WriteString("// Code generated by sqlc-ydb. DO NOT EDIT.\n#pragma once\n\n#include \"models.hpp\"\n\n#include <cstdint>\n#include <optional>\n#include <string>\n#include <vector>\n")
...
func renderSource(in *model.AnalysisResult, options Options) (string, error) {
	var out strings.Builder
	out.WriteString("// Code generated by sqlc-ydb. DO NOT EDIT.\n#include \"queries.hpp\"\n")
	if options.Runtime == "ydb" {
	...
	for _, query := range in.Queries {
		var err error
		if options.Runtime == "ydb" {
			err = renderNativeMethod(&out, query, options)
		} else {
			err = renderUserverMethod(&out, query, options)
		}
		if err != nil {
			return "", err
		}
...
func renderNativeMethod(out *strings.Builder, query model.AnalyzedQuery, options Options) error {
	returnType := "void"
	if query.Command == model.One {
		returnType = "std::optional<" + query.Name + "Row>"
	} else if query.Command == model.Many {
...
func renderUserverMethod(out *strings.Builder, query model.AnalyzedQuery, options Options) error {
	returnType := "void"
	if query.Command == model.One {
		returnType = "std::optional<" + query.Name + "Row>"
	} else if query.Command == model.Many {

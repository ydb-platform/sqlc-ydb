...
func Generate(a *model.AnalysisResult, o Options) ([]model.File, error) {
	...
	owner := map[string]string{"ydb": "QueryTransaction", "jdbc": "java.sql.Connection", "spring": "org.springframework.jdbc.core.JdbcTemplate", "hibernate": "org.hibernate.Session"}[o.Runtime]

...
require dirname(__DIR__, 3) . '/internal/endtoend/testdata/php_codec/expected/php/YdbRuntime.php';
...
foreach (['authors', 'batch', 'booktest', 'jets', 'ondeck'] as $family) {
    foreach (glob(dirname(__DIR__, 3) . '/examples/' . $family . '/php/native/*.php') ?: [] as $file) {
